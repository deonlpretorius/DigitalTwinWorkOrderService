...
/// <summary>
/// Namespace <c>DigitalTwinWorkOrderService.Models</c> contains the data models that represent the database tables for the application.
/// </summary>
namespace DigitalTwinWorkOrderService.Models
{
    /// <summary>
