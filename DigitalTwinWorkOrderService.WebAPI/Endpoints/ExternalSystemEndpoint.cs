...
/// <summary>
/// Namespace <c>DigitalTwinWorkOrderService.Endpoints</c> contains the HTTP Endpoints and Route Groupings for the Work Order Service application.
/// </summary>
namespace DigitalTwinWorkOrderService.Endpoints
{
    /// <summary>
