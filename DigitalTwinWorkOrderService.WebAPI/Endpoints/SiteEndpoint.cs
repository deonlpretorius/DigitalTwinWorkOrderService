using DigitalTwinWorkOrderService.Models;
using DigitalTwinWorkOrderService.WebAPI.Interfaces;
using Microsoft.AspNetCore.Http.HttpResults;

/// <summary>
/// Namespace <c>DigitalTwinWorkOrderService.WebAPI.Endpoints</c> contains the HTTP Endpoints and Route Groupings for the Work Order Service application.
/// </summary>
namespace DigitalTwinWorkOrderService.WebAPI.Endpoints
{
    /// <summary>
