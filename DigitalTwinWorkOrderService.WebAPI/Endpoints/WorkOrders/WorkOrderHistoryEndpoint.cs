using DigitalTwinWorkOrderService.Enums.WorkOrders;
using DigitalTwinWorkOrderService.Models.WorkOrders;
using DigitalTwinWorkOrderService.WebAPI.Interfaces.WorkOrders;

/// <summary>
/// Namespace <c>DigitalTwinWorkOrderService.WebAPI.Endpoints.WorkOrders</c> contains the HTTP Endpoints and Route Groupings for the Work Order Service application.
/// </summary>
namespace DigitalTwinWorkOrderService.WebAPI.Endpoints.WorkOrders
{
    /// <summary>
